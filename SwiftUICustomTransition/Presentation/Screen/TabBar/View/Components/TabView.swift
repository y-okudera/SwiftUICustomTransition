...
extension View {
    func tabItem(_ title: String, image: UIImage?, selectedImage: UIImage? = nil, badgeValue: String? = nil) -> TabView.TabBarItem {
        TabView.TabBarItem(
            title: title,
            image: image,
...
@resultBuilder
struct TabBuilder {
    static func buildBlock(_ elements: TabView.TabBarItem...) -> [TabView.TabBarItem] {
        elements
    }
}
